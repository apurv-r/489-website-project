...
export default function HostListingDetails() {
  ...
  const address = [
    ...
    .filter(Boolean)
    .join(", ");
  const listingVisibilityStatus = !listing.isPublished
    ? "Unpublished"
    : listing.isVerified
      ? "Published (Public)"
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: "1.5rem" }}>
            <div>
                ...
                >
                  ...
                  {listing.imageUrls.length > 1 && (
                    <div
                      style={{
                        display: "grid",
                        gridTemplateColumns: `repeat(${Math.min(listing.imageUrls.length - 1, 4)},1fr)`,
                        gap: 4,
                        padding: 4,
                      }}
                    >
              ...
              <div className="dash-card" style={{ marginBottom: "1.5rem" }}>
                ...
                >
                  {[
                    ...
                    { label: "Status", value: listingVisibilityStatus },
                    {
                      label: "Amenities",
                      value: listing.amenities?.length ? listing.amenities.join(", ") : "None",
                    },
                  ].map((item) => (
                    <div key={item.label}>
                      <p
              ...
              <div className="dash-card">
                ...
                {bookings.length === 0 ? (
                  <p style={{ color: "var(--nexa-gray-500)", marginTop: "1rem" }}>
                    ...
                    {bookings.map((b) => (
                      ...
                      >
                        <div>
                          ...
                          <p
                            style={{ fontSize: "0.8rem", color: "var(--nexa-gray-500)", margin: 0 }}
                          >
                        ...
                        <Link
                          ...
                          className="btn btn-nexa-outline btn-nexa-sm ms-3"
                        >
                          View
                        </Link>
                      </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
              ...
              <div className="dash-card">
                ...
                {[
                  ...
                  {
                    label: "Total earned",
                    value: `$${bookings.reduce((sum, b) => sum + (b.totalAmount || 0), 0).toFixed(2)}`,
                  },
                  {
                    label: "Rating",
                    value: listing.ratingAverage > 0 ? `${listing.ratingAverage} ★` : "No rating",
                  },
                  ...
                  >
                    <span style={{ color: "var(--nexa-gray-400)", fontSize: "0.875rem" }}>
                      {s.label}
                    </span>
