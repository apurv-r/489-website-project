            ...
            <form className="auth-form" onSubmit={handleSubmit} noValidate>
              <div className="auth-field">
                ...
                <div className="role-toggle">
                  <button
                    type="button"
                    className={`role-toggle-btn${role === "renter" ? " active" : ""}`}
                  ...
                  <button
                    type="button"
                    className={`role-toggle-btn${role === "host" ? " active" : ""}`}
              ...
              <div className="auth-terms">
                ...
                <label htmlFor="agreeTerms">
                  I agree to the <Link to="/register">Terms of Service</Link>{" "}
                  and <Link to="/register">Privacy Policy</Link>
                </label>
              </div>
